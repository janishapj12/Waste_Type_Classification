...
BASE_OUTPUT_DIR = SCRIPT_DIR / "output_v2"
MODEL_OUTPUT_DIR = BASE_OUTPUT_DIR / "svm"
...
# =========================
required_files = [
    BASE_OUTPUT_DIR / "X_train_pca.npy",
    BASE_OUTPUT_DIR / "X_test_pca.npy",
    BASE_OUTPUT_DIR / "y_train.npy",
    BASE_OUTPUT_DIR / "y_test.npy",
    BASE_OUTPUT_DIR / "label_encoder.pkl"
]

missing_files = [str(f) for f in required_files if not f.exists()]
if missing_files:
    raise FileNotFoundError(
        "These required files were not found in output_v2:\n"
        + "\n".join(missing_files)
        + "\n\nRun preprocess_v2.py first, or check your folder paths."
    )
...
plt.ylim(0, 1)
plt.title("Per-Class F1 Score - SVM")
plt.ylabel("F1 Score")
