...
MODEL_OUTPUT_DIR = BASE_OUTPUT_DIR / "random_forest"
MODEL_OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# =========================
# LOAD DATA
# =========================
X_train = np.load(BASE_OUTPUT_DIR / "X_train_scaled.npy")
X_test = np.load(BASE_OUTPUT_DIR / "X_test_scaled.npy")
...
plt.ylim(0, 1)
plt.title("Overall Metrics - Random Forest")
plt.ylabel("Score")
...
plt.ylim(0, 1)
plt.title("Per-Class F1 Score - Random Forest")
plt.ylabel("F1 Score")
